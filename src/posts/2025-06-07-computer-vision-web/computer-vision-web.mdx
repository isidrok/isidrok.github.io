...
The result: a browser app that counts reps in real-time using your webcam, with audio feedback, workout history, and local video recording — [try it here](https://isidrok.github.io/kb-sport-app/).
