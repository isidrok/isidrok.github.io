...
If you have been working with Claude and building MCP servers, you might have found use cases in which you need to upload files from an agent to your server.
Unfortunately, the MCP doesn't support file uploads natively yet, [there is a charter](https://modelcontextprotocol.io/community/working-groups/file-uploads) dedicated to solve this but in the mean time you can achieve it by using a simple workaround: pre-signed URLs.
