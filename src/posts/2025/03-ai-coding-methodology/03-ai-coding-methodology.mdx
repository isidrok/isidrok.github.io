...
I believe pair programming is the best way to write code, but only when people truly collaborate. Screen sharing isn't enough. You need active discussion, idea sharing, question asking, and assumption challenging. Without this, you're just dictating or taking orders.
...
Starting from the [previous post](/blog/computer-vision-web/) in which we studied how to run computer vision models in the browser, we will now explore how to use this methodology to complete our KB sports app.
...
The KB Sport app built using this methodology is available at [https://github.com/isidrok/kb-sports-app](https://github.com/isidrok/kb-sport-app). Try it out at [https://isidrok.github.io/kb-sport-app/](https://isidrok.github.io/kb-sport-app/).
