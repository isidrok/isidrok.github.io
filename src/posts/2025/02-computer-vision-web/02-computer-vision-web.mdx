...
This got me thinking: there must be a way to use machine learning models to track repetitions in real-time, and there must be a way to run them directly in the browser.
