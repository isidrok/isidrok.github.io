...
In order to analyze images or content that is not properly readable as text, we can instruct our agent to save images to the sandbox disk, and call a tool that will put it in the conversation context encoded in base 64.
