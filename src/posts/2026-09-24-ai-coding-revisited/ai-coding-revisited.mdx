...
The business problem and high-level design are highly specific to each project. For the low-level design, however, I usually end up with some flavor of Clean Architecture.
