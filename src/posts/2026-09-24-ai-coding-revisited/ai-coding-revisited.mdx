...
1. **You are responsible for the code you push.** "Claude did it" is not a valid excuse. If you don't understand the code you're about to push, just ask the AI.
...
3. **Work in chunks and review the output before committing.** I usually have Claude Desktop on one screen and my IDE on the other. I'll ask for something, review it, and ask for changes if needed before committing.
